...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        ...
        try:
            ...
            raw_data_dir=dataingestion.initiate_data_ingestion()
            return raw_data_dir
    ...
    def start_data_transformation(self,valid_data_dir):
        ...
        try:
            data_transformation=DataTransformation(valid_data_dir)
    ...
    def run_pipeline(self):
        try:
            ...
            model_trainer=ModelTrainer()
            return model_trainer.model_trainer_config.trained_model_path
